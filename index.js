...
class Car {
  ...
  drive(milesWanted) {
    var milesLeft = this.tank * this.milesPerGallon;
  
    if (milesWanted > milesLeft){
      this.odometer += milesLeft;
      this.tank = 0;
      return `I ran out of fuel at ${this.odometer} miles!`;
    }
    else {
      this.tank -= (milesWanted / this.milesPerGallon);
      this.odometer += milesWanted;
    }
  }
}
...
class Instructor extends Lambdasian {
  ...
  assignRandomGradeToStudent(student) {
